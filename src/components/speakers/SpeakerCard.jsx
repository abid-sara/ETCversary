...
const SpeakerCard = ({ name, description, pic, ig, fb, ln }) => {
  return (
    <div className="min-w-[25%] sm:w-[22em] h-auto border border-2 border-white/20 bg-gradient-to-b from-white/10 to-black/10 flex flex-col gap-6 px-5 py-6">
